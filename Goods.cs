...
public class Goods
{
    ...
    {
        FLAX, LINEN, CEDAR, EBONY, PAPYRUS
    }

    public enum MaterialNatural
    {
        SALT, FLINT, STONE, CLAY, IRON, COPPER, SILVER, GOLD, 
        LEAD, MALACHITE, LAPIS_LAZULI, OBSIDIAN, TIN
    }

    public enum CraftGoods
    {
        CLOTHING, BRICKS, COMBS, JEWELRY, POTTERY, STATUES, INSTRUMENTS
    }

    public enum WarGoods
    {
    ...
    public float[,] USE_RATE = {
        ...
        {/*PICKAXE*/0.005f, /*SHOVEL*/0f, /*HAMMER*/0.05f, /*KILN*/0f, /*FURNACE*/0f, /*SAW*/0.005f, /*KNIFE*/0.005f,
         /*SPEAR*/0f, /*FISHING_NET*/0.005f, /*AXE*/0.05f, 0f, 0f, 0f, 0f, 0f, 0f, 0f},

        // These materials are stable, only consumed when converted into something else
        {/*IVORY*/0f, /*BONE*/0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f},

        {/*FLAX*/0f, /*LINEN*/0f, /*CEDAR*/0f, /*EBODY*/0f, /*PAPYRUS*/0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f},

        {/*SALT*/0.05f, /*FLINT*/0f, /*STONE*/0f, /*CLAY*/0f, /*IRON*/0f, /*COPPER*/0f, /*SILVER*/0f, /*GOLD*/0f,
         /*LEAD*/0f, /*MALACHITE*/0f, /*LAPIS_LAZULI*/0f, /*OBSIDIAN*/0f, /*TIN*/0f, 0f, 0f, 0f, 0f},

        {/*CLOTHING*/0.005f, /*BRICKS*/0f, /*COMBS*/0.005f, /*JEWELRY*/0f, /*POTTERY*/0f, /*STATUES*/0f, /*INSTRUMENTS*/0.005f, 
    ...
    public override string ToString()
    {
        ...
        switch (Type)
        {
            ...
            case GoodsType.CRAFT_GOODS: subTypeName = Enum.GetName(typeof(CraftGoods), SubType); break;
            case GoodsType.WAR_GOODS: subTypeName = Enum.GetName(typeof(WarGoods), SubType); break;
        }
    ...
    {
        int before = Quantity;
        Quantity = MathHelper.Max(0, Quantity - quantity);
    ...
    public bool IsCraftGood(CraftGoods t)
    {
        return Type == GoodsType.CRAFT_GOODS && (CraftGoods)SubType == t;
    }

    public bool IsWarGood(WarGoods t)
    {
        return Type == GoodsType.WAR_GOODS && (WarGoods)SubType == t;
    }
}